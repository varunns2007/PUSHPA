...
class ChangeEvent(BaseModel):
    ...
    severity: str
    status: str = "Needs Investigation"
    risk_score: int
...
class HistoricalIncident(BaseModel):
    ...
    forest_area_id: str
    forest_name: str
    incident_type: str  # Illegal Logging, Timber Smuggling, Encroachment
...
class Alert(BaseModel):
    id: str
    timestamp: str
    alert_type: str  # Forest Change, Permit Mismatch, Route Anomaly, Correlation, Critical
